  ...
  return (
    <div className="reviews-box">
      <article className="review">
        <img src={reviewPortF} alt="review-port" className="review__portrait"/>
        <div className="review-description">
          <h3 className="review-description-title">Екатерина Вальнова</h3>
      ...
      <article className="review">
        <img src={reviewPortS} alt="review-port" className="review__portrait"/>
        <div className="review-description">
          <h3 className="review-description-title">Евгений Стрыкало</h3>
          <span className="review-description-text">
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              width="13" 
